...
public class AddAppointmentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        LocalTime start2 = LocalTime.of(8,15); //end time appt starts 15 mins after first start time slot: 8AM
    ...
    public void onActionAddApptBtn(ActionEvent actionEvent) throws IOException {
        ...
        LocalTime startApptTime = (LocalTime) addApptStartTimeCombo.getValue();

        //Grab the end appointment time selected:
        LocalTime endApptTime = (LocalTime) addApptEndTimeCombo.getValue();
